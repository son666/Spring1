...
<body>
  ...
  <div style="height: 100vh">
    <div class="flex-center flex-column">
        ...
        <form:form class="text-center border border-light p-5" action="/" modelAttribute="product">
            <p class="h4 mb-4">Add product</p>
            <!-- Title -->
            <form:input path="title" type="text" id="titleProduct" class="form-control mb-4" placeholder="${product.title}"/>
            <!-- Coast -->
            <form:input path="coast" type="text" id="coastProduct" class="form-control mb-4" placeholder="${product.coast}"/>
            <button class="btn btn-info btn-block" type="submit">Back</button>
        </form:form>
